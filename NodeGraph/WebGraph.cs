...
public class WebGraph
{
    ...
    public static Node StyleNode(string url, Graph graph, int linkedNodeCount = 0) // Include linkedNodeCount as a parameter
    {
        ...
        else if (linkedNodeCount <= maxLinkedNodesPurple)
        {
            ...
            blueShade = (byte)(255 * Math.Min((linkedNodeCount - maxLinkedNodesRed) / (double)(maxLinkedNodesPurple - maxLinkedNodesRed), 1.0));
            redShade = (byte)(255 - redShade); // Making purple by combining red and blue
            // i switched these colors around...
        }
        else
        {
